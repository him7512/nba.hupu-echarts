...
# 打开CSV文件进行写入
with open('KevinDurant_REGULAR.csv', 'w', newline="", encoding='utf-8') as f1:
...
with open('KevinDurant_PLATOFFS.csv', 'w', newline="", encoding='utf-8') as f2:
    ...
    for i in range(1, 14):
        csv_writer.writerow([
            ...
            # trs2[i].xpath("./td[6]/text()")[0].split('-')[0],
            trs2[i].xpath("./td[6]/text()")[0],
            trs2[i].xpath("./td[7]/text()")[0],
            # trs2[i].xpath("./td[8]/text()")[0].split('-')[0],
            trs2[i].xpath("./td[8]/text()")[0],
            trs2[i].xpath("./td[9]/text()")[0],
            # trs2[i].xpath("./td[10]/text()")[0].split('-')[0],
